...
%% Initialization:
load('experiment1_train_ble_rssi_mat.mat');
...
beacon_id_color_map = [1 0 0; 0 1 0; 0 0 1];
...
edges_details_path = 'Parsed_Data\experiment1\edges.csv';
...
plot(user_loc_mat_1(1,:), user_loc_mat_1(2,:),'r*',user_loc_mat_6(1,:), user_loc_mat_6(2,:),'go',user_loc_mat_9(1,:), user_loc_mat_9(2,:),'b^')
hold on; plot(edges_details.edge_x, edges_details.edge_y, 'sk','MarkerFaceColor','m','MarkerSize',10,'LineWidth',2); hold off;
xlabel('x [m]'); ylabel('y [m]');
title('Randomly Chosen User-Locations for Exp. 1')
...
scatter3(DataMatrix_new(:,1),DataMatrix_new(:,2),DataMatrix_new(:,3),[],distance_mat(2,indices));
